...
if (has('termguicolors'))
    let s:top_left = (&background ==# 'dark') ? '#120F0C' : '#EDEAE7'
    let s:top_right = (&background ==# 'dark') ? '#D0CFCE' : '#B8B7B6'
    let s:bottom_left = (&background ==# 'dark') ? '#575553' : '#D9D7D5'
    let s:bottom_right = (&background ==# 'dark') ? '#FFFDFA' : '#120F0C'
